...
public class ExceptionAdvice {
    ...
    public Result handle401(ShiroException e) {
        return ResultGenerator.getFailureInfo( "无权访问(Unauthorized):" + e.getMessage());
    }
    ...
    public Result handle401(UnauthorizedException e) {
        ...
        return ResultGenerator.getFailureInfo("无权访问(Unauthorized):当前Subject没有此请求所需权限(" + e.getMessage() + ")");
    }
    ...
    public Result handle401(UnauthenticatedException e) {
        return ResultGenerator.getFailureInfo("无权访问(Unauthorized):当前Subject是匿名Subject，请先登录(This subject is anonymous.)");
    }
    ...
    public Result validException(BindException e) {
        ...
        return ResultGenerator.getFailureInfo(error.get("errorMsg").toString());
    }
    ...
    public Result handle(NoHandlerFoundException e) {
        return ResultGenerator.getFailureInfo(e.getMessage());
    }
    ...
    public Result globalException(HttpServletRequest request, Throwable ex) {
        return ResultGenerator.getFailureInfo(ex.toString() + ": " + ex.getMessage());
    }
